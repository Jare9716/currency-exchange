...
import { Box, Button, TextField, Typography, Link, InputAdornment, IconButton, Checkbox, FormControlLabel } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box component="form" sx={{ width: '100%', maxWidth: '520px', display: 'flex', flexDirection: 'column', gap: 2 }}>
          <TextField
            fullWidth
            label="Correo"
            variant="outlined"
